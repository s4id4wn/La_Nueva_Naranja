...
$this->menu=array(
	...
	array('label'=>'Eliminar Tipo de Equipo', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'¿Esta seguro que desea eliminar este elemento?'),'visible'=>$model->active==1),
...
<h1>Vista Tipo de Equipo #<?php echo $model->id; ?></h1>
